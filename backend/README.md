...
- Déploiement Railway (`backend-app`) connecté au repo GitHub via la GitHub App Railway (branche `main`, root directory `backend`, auto-deploy activé) : tout push sur `main` redéploie automatiquement
